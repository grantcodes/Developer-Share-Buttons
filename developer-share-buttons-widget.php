    ...
    */
    class Dev_Share_Buttons_Widget extends WP_Widget {
        ...
        function __construct() {
            parent::__construct(
                DeveloperShareButtons::$slug_ . '_widget', // Base ID
                __('Developer Share Buttons', 'dev-share-buttons'), // Name
                array( 'description' => __( 'Developer Share Buttons Widget', 'dev-share-buttons' ), ) // Args
            );
        }
    ...
    } // class Dev_Share_Buttons_Widget
}
...
if ( !class_exists( 'Dev_Share_Buttons_Profiles_Widget' ) ) {
    ...
    class Dev_Share_Buttons_Profiles_Widget extends WP_Widget {
        ...
        function __construct() {
            parent::__construct(
                DeveloperShareButtons::$slug_ . '_profiles_widget', // Base ID
                __('Developer Share Buttons Profiles', 'dev-share-buttons-profiles'), // Name
                array( 'description' => __( 'Developer Share Buttons Social Profiles Widget', 'dev-share-buttons-profiles' ), ) // Args
            );
        }
    ...
    } // class Dev_Share_Buttons_Profiles_Widget
}